...
import { FaFacebookF, FaInstagram, FaWhatsapp, FaYoutube, FaPhoneAlt, FaClock, FaMapMarkerAlt } from "react-icons/fa";
...
function Footer() {
  ...
  <div className="flex space-x-4 text-xl">
    <a href="#"><FaFacebookF className="text-[#76B74E]" /></a>
    <a href="#"><FaInstagram className="text-[#76B74E]" /></a>
    <a href="#"><FaWhatsapp className="text-[#76B74E]" /></a>
    <a href="#"><FaYoutube className="text-[#76B74E]" /></a>
  </div>
        {/* Copyright */}
        <p className="text-sm text-gray-500 mt-4 md:mt-0">
         ©2025 ChattaSeed Corporation All rights reserved.
        </p>
        <p>Powered By: ©BizCode</p>
      </div>
    </footer>
  );
}
