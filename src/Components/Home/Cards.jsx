...
{showCart && (
  ...
  <h3 className="text-lg font-bold mb-4 text-gray-800 border-b pb-2 text-center md:text-left">
    You may also like
  </h3>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    {products
      ...
      .map((p, i) => (
        <div
          key={i}
          className="bg-gray-50 shadow-sm hover:shadow-md rounded-xl p-3 text-center"
        >
          <img
            src={p.img}
            alt={p.title}
